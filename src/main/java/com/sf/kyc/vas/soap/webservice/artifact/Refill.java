...
public class Refill {
    ...
    @XmlElementRef(name = "voucher", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> voucher;
    @XmlElementRef(name = "externalData1", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> externalData1;
     ...
     *     
     */
    public JAXBElement<String> getExternalData1() {
     ...
     *     
     */
    public void setExternalData1(JAXBElement<String> value) {
